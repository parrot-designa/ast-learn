...
exports.unicodeRegExp = exports.stripParensRE = exports.startTagOpen = exports.startTagClose = exports.simplePathRE = exports.onRE = exports.modifierRE = exports.forIteratorRE = exports.forAliasRE = exports.fnInvokeRE = exports.fnExpRE = exports.endTag = exports.dynamicArgRE = exports.dynamicArgAttribute = exports.dirRE = exports.bindRE = exports.attribute = exports.argRE = void 0;
/**
 * 用于匹配一系列 Unicode 字符集中的字符
 */
var unicodeRegExp = exports.unicodeRegExp = /a-zA-Z\u00B7\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u037D\u037F-\u1FFF\u200C-\u200D\u203F-\u2040\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD/;
 ...
 */
var startTagOpen = exports.startTagOpen = new RegExp("^<".concat(qnameCapture));
 ...
 * 3. :#[key] = 'world'
 */
var dynamicArgAttribute = exports.dynamicArgAttribute = /^\s*((?:v-[\w-]+:|@|:|#)\[[^=]+?\][^\s"'<>\/=]*)(?:\s*(=)\s*(?:"([^"]*)"+|'([^']*)'+|([^\s"'=<>`]+)))?/;
 ...
 */
var endTag = exports.endTag = new RegExp("^<\\/".concat(qnameCapture, "[^>]*>"));
 ...
 */
var dynamicArgRE = exports.dynamicArgRE = /^\[.*\]$/;
 ...
 */
var forAliasRE = exports.forAliasRE = /([\s\S]*?)\s+(?:in|of)\s+([\s\S]*)/;
...
var simplePathRE = exports.simplePathRE = /^[A-Za-z_$][\w$]*(?:\.[A-Za-z_$][\w$]*|\['[^']*?']|\["[^"]*?"]|\[\d+]|\[[A-Za-z_$][\w$]*])*$/;
var fnExpRE = exports.fnExpRE = /^([\w$_]+|\([^)]*?\))\s*=>|^function(?:\s+[\w$]+)?\s*\(/;
var fnInvokeRE = exports.fnInvokeRE = /\([^)]*?\);*$/;